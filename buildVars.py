...
addon_info = {
	...
	"addon_name" : "WakeSpeaker",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary" : _("Wake Speaker"),
	# Add-on description
	...
	"addon_url" : "https://github.com/davidacm/WakeSpeaker",
	...
	"addon_sourceURL": "https://github.com/davidacm/WakeSpeaker",
}
...
pythonSources = [path.join("addon", "globalPlugins", "*.py")]
